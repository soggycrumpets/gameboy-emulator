...
impl Cpu {
    ...
    fn execute_prefixed(&mut self) {
        ...
        match opcode {
            0x00 => self.bitop_r8(Bitop::RLC, R8::B), // RLC B
            0x00 => self.bitop_r8(Bitop::RLC, R8::B), // RLC C
            0x00 => self.bitop_r8(Bitop::RLC, R8::B), // RLC D
            0x00 => self.bitop_r8(Bitop::RLC, R8::B), // RLC E
            0x00 => self.bitop_r8(Bitop::RLC, R8::B), // RLC H
            0x00 => self.bitop_r8(Bitop::RLC, R8::B), // RLC L
            0x00 => self.bitop_r8(Bitop::RLC, R8::B), // RLC [HL]
            0x00 => self.bitop_r8(Bitop::RLC, R8::B), // RLC A
            0x00 => self.bitop_r8(Bitop::RLC, R8::B), // RRC B
            0x00 => self.bitop_r8(Bitop::RLC, R8::B), // RRC B
            0x00 => self.bitop_r8(Bitop::RLC, R8::B), // RRC B
            0x00 => self.bitop_r8(Bitop::RLC, R8::B), // RRC B
            0x00 => self.bitop_r8(Bitop::RLC, R8::B), // RRC B
