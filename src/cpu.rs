...
impl Cpu {
    ...
    pub fn execute(&mut self) {
        ...
        match opcode {
            ...
            0x07 => self.bitshift_r8(Bitshift::Rrc, R8::A), // RLCA
            ...
            0x0F => self.bitshift_r8(Bitshift::Rrc, R8::A), // RRCA
            ...
            0x17 => self.bitshift_r8(Bitshift::Rl, R8::A), // RLA
            ...
            0x1F => self.bitshift_r8(Bitshift::Rr, R8::A), // RRA
    ...
    fn execute_prefixed(&mut self) {
        ...
        match opcode {
            ...
            0x28 => self.bitshift_r8(Bitshift::Sra, R8::B), // SRA B
            ...
            0x70 => self.bitflag_u3_r8(Bitflag::Bit, 6, R8::B), // BIT 6, B
            0x71 => self.bitflag_u3_r8(Bitflag::Bit, 6, R8::C), // BIT 6, C
            0x72 => self.bitflag_u3_r8(Bitflag::Bit, 6, R8::D), // BIT 6, D
            0x73 => self.bitflag_u3_r8(Bitflag::Bit, 6, R8::E), // BIT 6, E
            0x74 => self.bitflag_u3_r8(Bitflag::Bit, 6, R8::H), // BIT 6, H
            0x75 => self.bitflag_u3_r8(Bitflag::Bit, 6, R8::L), // BIT 6, L
            0x76 => self.bitflag_u3_at_hl(Bitflag::Bit, 6),     // BIT 6, [HL]
            0x77 => self.bitflag_u3_r8(Bitflag::Bit, 6, R8::A), // BIT 6, A
            0x78 => self.bitflag_u3_r8(Bitflag::Bit, 7, R8::B), // BIT 7, B
            0x79 => self.bitflag_u3_r8(Bitflag::Bit, 7, R8::C), // BIT 7, C
            0x7A => self.bitflag_u3_r8(Bitflag::Bit, 7, R8::D), // BIT 7, D
            0x7B => self.bitflag_u3_r8(Bitflag::Bit, 7, R8::E), // BIT 7, E
            0x7C => self.bitflag_u3_r8(Bitflag::Bit, 7, R8::H), // BIT 7, H
            0x7D => self.bitflag_u3_r8(Bitflag::Bit, 7, R8::L), // BIT 7, L
            0x7E => self.bitflag_u3_at_hl(Bitflag::Bit, 7),     // BIT 7, [HL]
            0x7F => self.bitflag_u3_r8(Bitflag::Bit, 7, R8::A), // BIT 7, A

            0x80 => self.bitflag_u3_r8(Bitflag::Res, 0, R8::B), // RES 0, B
            0x81 => self.bitflag_u3_r8(Bitflag::Res, 0, R8::C), // RES 0, C
            0x82 => self.bitflag_u3_r8(Bitflag::Res, 0, R8::D), // RES 0, D
            0x83 => self.bitflag_u3_r8(Bitflag::Res, 0, R8::E), // RES 0, E
            0x84 => self.bitflag_u3_r8(Bitflag::Res, 0, R8::H), // RES 0, H
            0x85 => self.bitflag_u3_r8(Bitflag::Res, 0, R8::L), // RES 0, L
            0x86 => self.bitflag_u3_at_hl(Bitflag::Res, 0),     // RES 0, [HL]
            0x87 => self.bitflag_u3_r8(Bitflag::Res, 0, R8::A), // RES 0, A
            0x88 => self.bitflag_u3_r8(Bitflag::Res, 1, R8::B), // RES 1, B
            0x89 => self.bitflag_u3_r8(Bitflag::Res, 1, R8::C), // RES 1, C
            0x8A => self.bitflag_u3_r8(Bitflag::Res, 1, R8::D), // RES 1, D
            0x8B => self.bitflag_u3_r8(Bitflag::Res, 1, R8::E), // RES 1, E
            0x8C => self.bitflag_u3_r8(Bitflag::Res, 1, R8::H), // RES 1, H
            0x8D => self.bitflag_u3_r8(Bitflag::Res, 1, R8::L), // RES 1, L
            0x8E => self.bitflag_u3_at_hl(Bitflag::Res, 1),     // RES 1, [HL]
            0x8F => self.bitflag_u3_r8(Bitflag::Res, 1, R8::A), // RES 1, A

            0x90 => self.bitflag_u3_r8(Bitflag::Res, 2, R8::B), // RES 2, B
            0x91 => self.bitflag_u3_r8(Bitflag::Res, 2, R8::C), // RES 2, C
            0x92 => self.bitflag_u3_r8(Bitflag::Res, 2, R8::D), // RES 2, D
            0x93 => self.bitflag_u3_r8(Bitflag::Res, 2, R8::E), // RES 2, E
            0x94 => self.bitflag_u3_r8(Bitflag::Res, 2, R8::H), // RES 2, H
            0x95 => self.bitflag_u3_r8(Bitflag::Res, 2, R8::L), // RES 2, L
            0x96 => self.bitflag_u3_at_hl(Bitflag::Res, 2),     // RES 2, [HL]
            0x97 => self.bitflag_u3_r8(Bitflag::Res, 2, R8::A), // RES 2, A
            0x98 => self.bitflag_u3_r8(Bitflag::Res, 3, R8::B), // RES 3, B
            0x99 => self.bitflag_u3_r8(Bitflag::Res, 3, R8::C), // RES 3, C
            0x9A => self.bitflag_u3_r8(Bitflag::Res, 3, R8::D), // RES 3, D
            0x9B => self.bitflag_u3_r8(Bitflag::Res, 3, R8::E), // RES 3, E
            0x9C => self.bitflag_u3_r8(Bitflag::Res, 3, R8::H), // RES 3, H
            0x9D => self.bitflag_u3_r8(Bitflag::Res, 3, R8::L), // RES 3, L
            0x9E => self.bitflag_u3_at_hl(Bitflag::Res, 3),     // RES 3, [HL]
            0x9F => self.bitflag_u3_r8(Bitflag::Res, 3, R8::A), // RES 3, A

            0xA0 => self.bitflag_u3_r8(Bitflag::Res, 4, R8::B), // RES 4, B
            0xA1 => self.bitflag_u3_r8(Bitflag::Res, 4, R8::C), // RES 4, C
            0xA2 => self.bitflag_u3_r8(Bitflag::Res, 4, R8::D), // RES 4, D
            0xA3 => self.bitflag_u3_r8(Bitflag::Res, 4, R8::E), // RES 4, E
            0xA4 => self.bitflag_u3_r8(Bitflag::Res, 4, R8::H), // RES 4, H
            0xA5 => self.bitflag_u3_r8(Bitflag::Res, 4, R8::L), // RES 4, L
            0xA6 => self.bitflag_u3_at_hl(Bitflag::Res, 4),     // RES 4, [HL]
            0xA7 => self.bitflag_u3_r8(Bitflag::Res, 4, R8::A), // RES 4, A
            0xA8 => self.bitflag_u3_r8(Bitflag::Res, 5, R8::B), // RES 5, B
            0xA9 => self.bitflag_u3_r8(Bitflag::Res, 5, R8::C), // RES 5, C
            0xAA => self.bitflag_u3_r8(Bitflag::Res, 5, R8::D), // RES 5, D
            0xAB => self.bitflag_u3_r8(Bitflag::Res, 5, R8::E), // RES 5, E
            0xAC => self.bitflag_u3_r8(Bitflag::Res, 5, R8::H), // RES 5, H
            0xAD => self.bitflag_u3_r8(Bitflag::Res, 5, R8::L), // RES 5, L
            0xAE => self.bitflag_u3_at_hl(Bitflag::Res, 5),     // RES 5, [HL]
            0xAF => self.bitflag_u3_r8(Bitflag::Res, 5, R8::A), // RES 5, A

            0xB0 => self.bitflag_u3_r8(Bitflag::Res, 6, R8::B), // RES 6, B
            0xB1 => self.bitflag_u3_r8(Bitflag::Res, 6, R8::C), // RES 6, C
            0xB2 => self.bitflag_u3_r8(Bitflag::Res, 6, R8::D), // RES 6, D
            0xB3 => self.bitflag_u3_r8(Bitflag::Res, 6, R8::E), // RES 6, E
            0xB4 => self.bitflag_u3_r8(Bitflag::Res, 6, R8::H), // RES 6, H
            0xB5 => self.bitflag_u3_r8(Bitflag::Res, 6, R8::L), // RES 6, L
            0xB6 => self.bitflag_u3_at_hl(Bitflag::Res, 6),     // RES 6, [HL]
            0xB7 => self.bitflag_u3_r8(Bitflag::Res, 6, R8::A), // RES 6, A
            0xB8 => self.bitflag_u3_r8(Bitflag::Res, 7, R8::B), // RES 7, B
            0xB9 => self.bitflag_u3_r8(Bitflag::Res, 7, R8::C), // RES 7, C
            0xBA => self.bitflag_u3_r8(Bitflag::Res, 7, R8::D), // RES 7, D
            0xBB => self.bitflag_u3_r8(Bitflag::Res, 7, R8::E), // RES 7, E
            0xBC => self.bitflag_u3_r8(Bitflag::Res, 7, R8::H), // RES 7, H
            0xBD => self.bitflag_u3_r8(Bitflag::Res, 7, R8::L), // RES 7, L
            0xBE => self.bitflag_u3_at_hl(Bitflag::Res, 7),     // RES 7, [HL]
            0xBF => self.bitflag_u3_r8(Bitflag::Res, 7, R8::A), // RES 7, A

            0xC0 => self.bitflag_u3_r8(Bitflag::Set, 0, R8::B), // SET 0, B
            0xC1 => self.bitflag_u3_r8(Bitflag::Set, 0, R8::C), // SET 0, C
            0xC2 => self.bitflag_u3_r8(Bitflag::Set, 0, R8::D), // SET 0, D
            0xC3 => self.bitflag_u3_r8(Bitflag::Set, 0, R8::E), // SET 0, E
            0xC4 => self.bitflag_u3_r8(Bitflag::Set, 0, R8::H), // SET 0, H
            0xC5 => self.bitflag_u3_r8(Bitflag::Set, 0, R8::L), // SET 0, L
            0xC6 => self.bitflag_u3_at_hl(Bitflag::Set, 0),     // SET 0, [HL]
            0xC7 => self.bitflag_u3_r8(Bitflag::Set, 0, R8::A), // SET 0, A
            0xC8 => self.bitflag_u3_r8(Bitflag::Set, 1, R8::B), // SET 1, B
            0xC9 => self.bitflag_u3_r8(Bitflag::Set, 1, R8::C), // SET 1, C
            0xCA => self.bitflag_u3_r8(Bitflag::Set, 1, R8::D), // SET 1, D
            0xCB => self.bitflag_u3_r8(Bitflag::Set, 1, R8::E), // SET 1, E
            0xCC => self.bitflag_u3_r8(Bitflag::Set, 1, R8::H), // SET 1, H
            0xCD => self.bitflag_u3_r8(Bitflag::Set, 1, R8::L), // SET 1, L
            0xCE => self.bitflag_u3_at_hl(Bitflag::Set, 1),     // SET 1, [HL]
            0xCF => self.bitflag_u3_r8(Bitflag::Set, 1, R8::A), // SET 1, A

            0xD0 => self.bitflag_u3_r8(Bitflag::Set, 2, R8::B), // SET 2, B
            0xD1 => self.bitflag_u3_r8(Bitflag::Set, 2, R8::C), // SET 2, C
            0xD2 => self.bitflag_u3_r8(Bitflag::Set, 2, R8::D), // SET 2, D
            0xD3 => self.bitflag_u3_r8(Bitflag::Set, 2, R8::E), // SET 2, E
            0xD4 => self.bitflag_u3_r8(Bitflag::Set, 2, R8::H), // SET 2, H
            0xD5 => self.bitflag_u3_r8(Bitflag::Set, 2, R8::L), // SET 2, L
            0xD6 => self.bitflag_u3_at_hl(Bitflag::Set, 2),     // SET 2, [HL]
            0xD7 => self.bitflag_u3_r8(Bitflag::Set, 2, R8::A), // SET 2, A
            0xD8 => self.bitflag_u3_r8(Bitflag::Set, 3, R8::B), // SET 3, B
            0xD9 => self.bitflag_u3_r8(Bitflag::Set, 3, R8::C), // SET 3, C
            0xDA => self.bitflag_u3_r8(Bitflag::Set, 3, R8::D), // SET 3, D
            0xDB => self.bitflag_u3_r8(Bitflag::Set, 3, R8::E), // SET 3, E
            0xDC => self.bitflag_u3_r8(Bitflag::Set, 3, R8::H), // SET 3, H
            0xDD => self.bitflag_u3_r8(Bitflag::Set, 3, R8::L), // SET 3, L
            0xDE => self.bitflag_u3_at_hl(Bitflag::Set, 3),     // SET 3, [HL]
            0xDF => self.bitflag_u3_r8(Bitflag::Set, 3, R8::A), // SET 3, A

            0xE0 => self.bitflag_u3_r8(Bitflag::Set, 4, R8::B), // SET 4, B
            0xE1 => self.bitflag_u3_r8(Bitflag::Set, 4, R8::C), // SET 4, C
            0xE2 => self.bitflag_u3_r8(Bitflag::Set, 4, R8::D), // SET 4, D
            0xE3 => self.bitflag_u3_r8(Bitflag::Set, 4, R8::E), // SET 4, E
            0xE4 => self.bitflag_u3_r8(Bitflag::Set, 4, R8::H), // SET 4, H
            0xE5 => self.bitflag_u3_r8(Bitflag::Set, 4, R8::L), // SET 4, L
            0xE6 => self.bitflag_u3_at_hl(Bitflag::Set, 4),     // SET 4, [HL]
            0xE7 => self.bitflag_u3_r8(Bitflag::Set, 4, R8::A), // SET 4, A
            0xE8 => self.bitflag_u3_r8(Bitflag::Set, 5, R8::B), // SET 4, B
            0xE9 => self.bitflag_u3_r8(Bitflag::Set, 5, R8::C), // SET 5, C
            0xEA => self.bitflag_u3_r8(Bitflag::Set, 5, R8::D), // SET 5, D
            0xEB => self.bitflag_u3_r8(Bitflag::Set, 5, R8::E), // SET 5, E
            0xEC => self.bitflag_u3_r8(Bitflag::Set, 5, R8::H), // SET 5, H
            0xED => self.bitflag_u3_r8(Bitflag::Set, 5, R8::L), // SET 5, L
            0xEE => self.bitflag_u3_at_hl(Bitflag::Set, 5),     // SET 5, [HL]
            0xEF => self.bitflag_u3_r8(Bitflag::Set, 5, R8::A), // SET 5, A

            0xF0 => self.bitflag_u3_r8(Bitflag::Set, 6, R8::B), // SET 6, B
            0xF1 => self.bitflag_u3_r8(Bitflag::Set, 6, R8::C), // SET 6, C
            0xF2 => self.bitflag_u3_r8(Bitflag::Set, 6, R8::D), // SET 6, D
            0xF3 => self.bitflag_u3_r8(Bitflag::Set, 6, R8::E), // SET 6, E
            0xF4 => self.bitflag_u3_r8(Bitflag::Set, 6, R8::H), // SET 6, H
            0xF5 => self.bitflag_u3_r8(Bitflag::Set, 6, R8::L), // SET 6, L
            0xF6 => self.bitflag_u3_at_hl(Bitflag::Set, 6),     // SET 6, [HL]
            0xF7 => self.bitflag_u3_r8(Bitflag::Set, 6, R8::A), // SET 6, A
            0xF8 => self.bitflag_u3_r8(Bitflag::Set, 7, R8::B), // SET 6, B
            0xF9 => self.bitflag_u3_r8(Bitflag::Set, 7, R8::C), // SET 7, C
            0xFA => self.bitflag_u3_r8(Bitflag::Set, 7, R8::D), // SET 7, D
            0xFB => self.bitflag_u3_r8(Bitflag::Set, 7, R8::E), // SET 7, E
            0xFC => self.bitflag_u3_r8(Bitflag::Set, 7, R8::H), // SET 7, H
            0xFD => self.bitflag_u3_r8(Bitflag::Set, 7, R8::L), // SET 7, L
            0xFE => self.bitflag_u3_at_hl(Bitflag::Set, 7),     // SET 7, [HL]
            0xFF => self.bitflag_u3_r8(Bitflag::Set, 7, R8::A), // SET 7, A
        }
    }
}
