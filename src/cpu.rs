...
impl Cpu {
    ...
    pub fn execute(&mut self) {
        ...
        match opcode {
            ...
            0x04 => self.alu_r8(AluOp::Inc, R8::B),           // INC B
            0x05 => self.alu_r8(AluOp::Dec, R8::B),           // DEC B
            ...
            0x0C => self.alu_r8(AluOp::Inc, R8::C),           // INC C
            0x0D => self.alu_r8(AluOp::Dec, R8::C),           // DEC C
            ...
            0x14 => self.alu_r8(AluOp::Inc, R8::D),          // INC D
            0x15 => self.alu_r8(AluOp::Dec, R8::D),          // DEC D
            ...
            0x1C => self.alu_r8(AluOp::Inc, R8::E),          // INC E
            0x1D => self.alu_r8(AluOp::Dec, R8::E),          // DEC E
            ...
            0x24 => self.alu_r8(AluOp::Inc, R8::H), // INC H
            0x25 => self.alu_r8(AluOp::Dec, R8::H), // DEC H
            ...
            0x2C => self.alu_r8(AluOp::Inc, R8::L), // INC L
            0x2D => self.alu_r8(AluOp::Dec, R8::L), // DEC L
            ...
            0x34 => self.alu_at_hl(AluOp::Inc),    // INC [HL]
            0x35 => self.alu_at_hl(AluOp::Dec),    // DEC [HL]
            ...
            0x3C => self.alu_r8(AluOp::Inc, R8::A), // INC A
            0x3D => self.alu_r8(AluOp::Dec, R8::A), // DEC A
            ...
            0x80 => self.alu_a_r8(AluOp::Add, R8::B), // ADD A, B
            0x81 => self.alu_a_r8(AluOp::Add, R8::C), // ADD A, C
            0x82 => self.alu_a_r8(AluOp::Add, R8::D), // ADD A, D
            0x83 => self.alu_a_r8(AluOp::Add, R8::E), // ADD A, E
            0x84 => self.alu_a_r8(AluOp::Add, R8::H), // ADD A, H
            0x85 => self.alu_a_r8(AluOp::Add, R8::L), // ADD A, L
            0x86 => self.alu_a_at_hl(AluOp::Add),     // ADD A, [HL]
            0x87 => self.alu_a_r8(AluOp::Add, R8::A), // ADD A, A
            0x88 => self.alu_a_r8(AluOp::Adc, R8::B), // ADC A, B
            0x89 => self.alu_a_r8(AluOp::Adc, R8::C), // ADC A, C
            0x8A => self.alu_a_r8(AluOp::Adc, R8::D), // ADC A, D
            0x8B => self.alu_a_r8(AluOp::Adc, R8::E), // ADC A, E
            0x8C => self.alu_a_r8(AluOp::Adc, R8::H), // ADC A, H
            0x8D => self.alu_a_r8(AluOp::Adc, R8::L), // ADC A, L
            0x8E => self.alu_a_at_hl(AluOp::Adc),     // ADC A, [HL]
            0x8F => self.alu_a_r8(AluOp::Adc, R8::A), // ADC A, A

            0x90 => self.alu_a_r8(AluOp::Sub, R8::B), // SUB A, B
            0x91 => self.alu_a_r8(AluOp::Sub, R8::C), // SUB A, C
            0x92 => self.alu_a_r8(AluOp::Sub, R8::D), // SUB A, D
            0x93 => self.alu_a_r8(AluOp::Sub, R8::E), // SUB A, E
            0x94 => self.alu_a_r8(AluOp::Sub, R8::H), // SUB A, H
            0x95 => self.alu_a_r8(AluOp::Sub, R8::L), // SUB A, L
            0x96 => self.alu_a_at_hl(AluOp::Sub),     // SUB A, [HL]
            0x97 => self.alu_a_r8(AluOp::Sub, R8::A), // SUB A, A
            0x98 => self.alu_a_r8(AluOp::Sbc, R8::B), // SBC A, B
            0x99 => self.alu_a_r8(AluOp::Sbc, R8::C), // SBC A, C
            0x9A => self.alu_a_r8(AluOp::Sbc, R8::D), // SBC A, D
            0x9B => self.alu_a_r8(AluOp::Sbc, R8::E), // SBC A, E
            0x9C => self.alu_a_r8(AluOp::Sbc, R8::H), // SBC A, H
            0x9D => self.alu_a_r8(AluOp::Sbc, R8::L), // SBC A, L
            0x9E => self.alu_a_at_hl(AluOp::Sbc),     // SBC A, [HL]
            0x9F => self.alu_a_r8(AluOp::Sbc, R8::A), // SBC A, A

            0xA0 => self.alu_a_r8(AluOp::And, R8::B), // AND A, B
            0xA1 => self.alu_a_r8(AluOp::And, R8::C), // AND A, C
            0xA2 => self.alu_a_r8(AluOp::And, R8::D), // AND A, D
            0xA3 => self.alu_a_r8(AluOp::And, R8::E), // AND A, E
            0xA4 => self.alu_a_r8(AluOp::And, R8::H), // AND A, H
            0xA5 => self.alu_a_r8(AluOp::And, R8::L), // AND A, L
            0xA6 => self.alu_a_at_hl(AluOp::And),     // AND A, [HL]
            0xA7 => self.alu_a_r8(AluOp::And, R8::A), // AND A, A
            0xA8 => self.alu_a_r8(AluOp::Xor, R8::B), // XOR A, B
            0xA9 => self.alu_a_r8(AluOp::Xor, R8::C), // XOR A, C
            0xAA => self.alu_a_r8(AluOp::Xor, R8::D), // XOR A, D
            0xAB => self.alu_a_r8(AluOp::Xor, R8::E), // XOR A, E
            0xAC => self.alu_a_r8(AluOp::Xor, R8::H), // XOR A, H
            0xAD => self.alu_a_r8(AluOp::Xor, R8::L), // XOR A, L
            0xAE => self.alu_a_at_hl(AluOp::Xor),     // XOR A, [HL]
            0xAF => self.alu_a_r8(AluOp::Xor, R8::A), // XOR A, A

            0xB0 => self.alu_a_r8(AluOp::Or, R8::B), // OR A, B
            0xB1 => self.alu_a_r8(AluOp::Or, R8::C), // OR A, C
            0xB2 => self.alu_a_r8(AluOp::Or, R8::D), // OR A, D
            0xB3 => self.alu_a_r8(AluOp::Or, R8::E), // OR A, E
            0xB4 => self.alu_a_r8(AluOp::Or, R8::H), // OR A, H
            0xB5 => self.alu_a_r8(AluOp::Or, R8::L), // OR A, L
            0xB6 => self.alu_a_at_hl(AluOp::Or),     // OR A, [HL]
            0xB7 => self.alu_a_r8(AluOp::Or, R8::A), // OR A, A
            0xB8 => self.alu_a_r8(AluOp::Cp, R8::B), // CP A, B
            0xB9 => self.alu_a_r8(AluOp::Cp, R8::C), // CP A, C
            0xBA => self.alu_a_r8(AluOp::Cp, R8::D), // CP A, D
            0xBB => self.alu_a_r8(AluOp::Cp, R8::E), // CP A, E
            0xBC => self.alu_a_r8(AluOp::Cp, R8::H), // CP A, H
            0xBD => self.alu_a_r8(AluOp::Cp, R8::L), // CP A, L
            0xBE => self.alu_a_at_hl(AluOp::Cp),     // CP A, [HL]
            0xBF => self.alu_a_r8(AluOp::Cp, R8::A), // CP A, A
            ...
            0xC6 => self.alu_a_n8(AluOp::Add),        // ADD A, n8
            ...
            0xCE => self.alu_a_n8(AluOp::Adc),        // ADC A, n8
            ...
            0xD6 => self.alu_a_n8(AluOp::Sub),        // SUB A, n8
            ...
            0xDD => unimplemented!(),                 // ---
            0xDE => self.alu_a_n8(AluOp::Sbc),        // SBC A, n8
            ...
            0xE6 => self.alu_a_n8(AluOp::And), // AND A, N8
            ...
            0xEC => unimplemented!(),          // ---
            0xED => unimplemented!(),          // ---
            0xEE => self.alu_a_n8(AluOp::Xor), // XOR A, n8
            ...
            0xF6 => self.alu_a_n8(AluOp::Or), // OR A, n8
            ...
            0xFC => unimplemented!(),         // ---
            0xFD => unimplemented!(),         // ---
            0xFE => self.alu_a_n8(AluOp::Cp), // CP A, n8
